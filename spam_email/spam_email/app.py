import os, json, threading, time, sys, importlib
...
try:
    from flask import Flask, render_template, redirect, url_for, request, jsonify  # type: ignore[import-not-found]
except Exception:  # pragma: no cover - helps editors/linters when flask isn't installed
    # Provide lightweight fallbacks so static analysis or editors won't error out.
    class Flask:  # minimal stand-in for type checks
